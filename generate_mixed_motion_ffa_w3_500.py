...
# Inputs
frequency_edge = 3.89 #3.6
frequency_flap = 3.89 #3.12

edge_amp_m = -0.014#0.16
flap_amp_m = -4.90E-4#0.53

#rot_avg_deg = 90
rot_amp_deg = 0.49#10.0
frequency_rot = 3.89#2.38
...
#    plt.show()
    ...
    plt.xlabel("t/T")
    plt.ylabel("Mixed Displacement [500]")
    plt.ylim([-4.1, 4.1])
    plt.grid()
    plt.legend()
    plt.show()
