...
# Inputs
frequency_edge = 2.44 #2.26
frequency_flap = 2.44 #1.95

edge_amp_m = -0.547 #1.08
flap_amp_m = -0.057 #3.62

#rot_avg_deg = 90
rot_amp_deg = 2.94 #10.0
frequency_rot = 2.44 #2.38
...
#    plt.show()
    ...
    plt.xlabel("t/T")
    plt.ylabel("Mixed Displacement [241]")
    plt.ylim([-4.1, 4.1])
    plt.grid()
    plt.legend()
    plt.show()
