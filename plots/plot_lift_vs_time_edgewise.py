...
def get_case_data_u_75():
    return pd.read_csv('/scratch/sbidadi/Dynamic_Stall/nalu_runs/ffa_w3_301/edgewise/aoa_90/ffa_w3_301_90.dat', sep="\s+", skiprows=1,header=None, names=[ "Time","Fpx","Fpy","Fpz","Fvx","Fvy","Fvz","Mtx","Mty","Mtz","Y+min","Y+max"],dtype=float)

def get_case_data_u_15():
    return pd.read_csv('/scratch/sbidadi/Dynamic_Stall/nalu_runs/ffa_w3_301/edgewise/aoa_90_u_15/ffa_w3_301_90.dat', sep="\s+", skiprows=1,header=None, names=[ "Time","Fpx","Fpy","Fpz","Fvx","Fvy","Fvz","Mtx","Mty","Mtz","Y+min","Y+max"],dtype=float)
