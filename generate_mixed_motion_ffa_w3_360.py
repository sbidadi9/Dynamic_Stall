...
# Inputs
frequency_edge = 3.95 #3.66
frequency_flap = 3.95 #3.16

edge_amp_m = -0.04 #0.26
flap_amp_m = -8.34E-4 #0.86

#rot_avg_deg = 90
rot_amp_deg = 0.97 #10.0
frequency_rot = 3.95 #2.38
...
#    plt.show()
    ...
    plt.xlabel("t/T")
    plt.ylabel("Mixed Displacement [360]")
    plt.ylim([-4.1, 4.1])
    plt.grid()
    plt.legend()
    plt.show()
