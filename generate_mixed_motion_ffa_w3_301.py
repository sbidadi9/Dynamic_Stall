...
# Inputs
frequency_edge = 3.07 #2.84
frequency_flap = 3.07 #2.45

edge_amp_m = -0.197 #0.59
flap_amp_m = -0.01 #1.98

#rot_avg_deg = 90
rot_amp_deg = 1.99 #10.0
frequency_rot = 3.07 #2.38
...
#    plt.show()
    ...
    plt.xlabel("t/T")
    plt.ylabel("Mixed Displacement [301]")
    plt.ylim([-4.1, 4.1])
    plt.grid()
    plt.legend()
    plt.show()
