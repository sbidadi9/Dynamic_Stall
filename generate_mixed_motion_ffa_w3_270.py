...
# Inputs
frequency_edge = 2.77 #2.56
frequency_flap = 2.77 #2.21

edge_amp_m = -0.337 #0.80
flap_amp_m = -0.026 #2.68

#rot_avg_deg = 90
rot_amp_deg = 2.46 #10.0
frequency_rot = 2.77 #2.38
...
#    plt.show()
    ...
    plt.xlabel("t/T")
    plt.ylabel("Mixed Displacement [270]")
    plt.ylim([-4.1, 4.1])
    plt.grid()
    plt.legend()
    plt.show()
